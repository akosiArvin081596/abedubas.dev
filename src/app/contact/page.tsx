  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="grid gap-12 md:grid-cols-2">
        {/* Contact Information */}
        <ScrollReveal animation="slide-right" duration={800} delay={100} easing="bounce">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="rounded-lg bg-muted p-3 transition-transform hover:scale-110">
                  <svg
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="rounded-lg bg-muted p-3 text-muted-foreground transition-all hover:bg-primary hover:text-white hover:scale-110"
                  aria-label="GitHub"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        {/* Contact Form */}
        <ScrollReveal animation="slide-left" duration={800} delay={200} easing="bounce">
